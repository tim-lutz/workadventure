...
>
    <section>
        <h2>{Translator.trans("camera.help.title")}</h2>
        <p class="err">{Translator.trans("camera.help.permission-denied")}</p>
        <p>{Translator.trans("camera.help.content")}</p>
        <p>
            {#if isFirefox}
                <p class="err">
                    {Translator.trans("camera.help.firefox-content")}
                </p>
