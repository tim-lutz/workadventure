...
<form class="selectCharacterScene">
    <section class="text-center">
        <h2>{Translator.trans("select-woka.title")}</h2>
    ...
    <section class="action">
        <button
            ...
            on:click|preventDefault={cameraScene}>{Translator.trans("select-woka.continue")}</button
        >
        <button
            type="submit"
            class="selectCharacterSceneFormCustomYourOwnSubmit nes-btn"
            on:click|preventDefault={customizeScene}>{Translator.trans("select-woka.customize")}</button
        >
    </section>
</form>
